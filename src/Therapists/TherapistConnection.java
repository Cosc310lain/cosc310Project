...
public class TherapistConnection implements AnxietyTherapist {
	public void AnxietyTherapistInvoked(String userName) {
		try {
			Thread.sleep(2000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		System.out.println("Thank you for reaching out about your Anxiety.");
		System.out.println("My name is Jacky Tuyen.\n"); 
	...
	public void DepressionTherapistInvoked(String userName) {
		try {
			Thread.sleep(2000);
		} catch (InterruptedException e) {
			e.printStackTrace();
	...
	public void OtherTherapistInvoked(String userName) {
		...
		System.out.println("My name is David Bero.\n"); 
		System.out.println("It would help me better serve you if I knew more about you. How old are you?");
		Scanner standardInput = new Scanner(System.in);
		// AGE QUESTION
		int age = 0;
	...
	public void StressedTherapistInvoked(String userName) {
		try {
			Thread.sleep(2000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		System.out.println("Thank you for reaching out about your Stress.");
		System.out.println("My name is Edward White.\n"); 
		System.out.println("It would help me better serve you if I knew more about you. How old are you?");
		Scanner standardInput = new Scanner(System.in);
		// AGE QUESTION
		int age = 0;
